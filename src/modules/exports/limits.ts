/**
 * Two small guards for the export renderer, kept free of I/O so they can be tested without a browser.
 *
 * A headless browser is the heaviest thing this app runs, so it is protected twice: a `Gate` bounds how many
