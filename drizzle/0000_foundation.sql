...
CREATE TABLE "profiles" (
	...
	"preferences_reviewed_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"version" integer DEFAULT 1 NOT NULL,
	CONSTRAINT "profiles_profession_chk" CHECK ("profiles"."profession" IS NULL OR "profiles"."profession" IN ('coach','pe_teacher','both')),
	CONSTRAINT "profiles_units_chk" CHECK ("profiles"."units" IN ('metric','imperial'))
);
--> statement-breakpoint
...
CREATE INDEX "audit_events_org_time_idx" ON "audit_events" USING btree ("organization_id","occurred_at");